...
import 'package:pomodoro_app/features/daily_news/presentation/widgets/article_widget.dart';
...
class SavedArticles extends HookWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<LocalArticleBloc>()..add(const GetLocalArticleEvent()),
      child: Scaffold(
        appBar: _buildAppBar(),
        body: _buildBody(),
      ),
  ...
  void _onRemoveArticle(BuildContext context, ArticleEntity article) {
    BlocProvider.of<LocalArticleBloc>(context)
        .add(RemoveLocalArticleEvent(article: article));
  }
